...
class _CalendarDatePickerState extends State<PersianCalendarDatePicker> {
  ...
  void initState() {
    ...
    _currentDisplayedMonthDate = Jalali(
    ...
    setState(() {
      ...
      if (_selectedDate case final Jalali selected) {
        final String message = switch (mode) {
          PersianDatePickerMode.day => _localizations.formatMonthYear(
            selected.toDateTime(),
          ),
          PersianDatePickerMode.year => _localizations.formatYear(
            selected.toDateTime(),
          ),
        };
      ...
      children: <Widget>[
        ...
        _DatePickerModeToggleButton(
          ...
          title: _localizations.formatMonthYear(
            _currentDisplayedMonthDate.toDateTime(),
          ),
...
class _MonthPickerState extends State<_MonthPicker> {
  ...
  void initState() {
    ...
    _pageController = PageController(
      initialPage: PersianDateUtils.monthDelta(widget.firstDate, _currentMonth),
    );
  ...
  void _handleMonthPageChanged(int monthPage) {
    setState(() {
      final Jalali monthDate = PersianDateUtils.addMonthsToMonthDate(
        widget.firstDate,
        monthPage,
      );
...
class _YearPickerState extends State<YearPicker> {
  ...
  Widget _buildYearItem(BuildContext context, int index) {
    ...
    if (isDisabled) {
      ...
      Jalali date = Jalali(
        year,
        widget.selectedDate?.month ?? JalaliExt.farvardin,
      );
      if (date.isBefore(
        Jalali(widget.firstDate.year, widget.firstDate.month),
      )) {
